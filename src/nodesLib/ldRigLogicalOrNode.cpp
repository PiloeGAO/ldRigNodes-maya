...
#include "ldRigLogicalOrNode.h"

MTypeId RigLogicalOrNode::id(0x01011);

MObject RigLogicalOrNode::inValue;
MObject RigLogicalOrNode::inValues;
MObject RigLogicalOrNode::inComparaisonType;
MObject RigLogicalOrNode::inSecondTerm;
MObject RigLogicalOrNode::inTrueValue;
MObject RigLogicalOrNode::inFalseValue;

MObject RigLogicalOrNode::outValue;
 ...
 * @return MStatus 
 */
MStatus RigLogicalOrNode::compute(const MPlug& plug, MDataBlock& data)
{
 ...
 * @return void* 
 */
void* RigLogicalOrNode::creator()
{
    return new RigLogicalOrNode();
}
 ...
 * @return MStatus 
 */
MStatus RigLogicalOrNode::initialize()
{
    MStatus stat;
